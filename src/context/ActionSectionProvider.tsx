...
export const ActionSectionContextProvider: React.FC<ActionSectionContextProviderProps> = ({
  children,
}) => {
...
export function useActiveSectionContext(): ActionSectionContextType {
  const context = useContext(ActionSectionContext);
  if (!context) {
    throw new Error("useActiveSectionContext must be used within a ActionSectionContextProvider");
  }
  return context;
}
